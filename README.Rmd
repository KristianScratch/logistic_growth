...
The code for comparing the Two models (exponential and logistic) can be found in "Analysis_Q123/Comparing_Models.R". We can also call it here:

```{r}
print(Comparing_Models_plot)
```

![plot](https://raw.githubusercontent.com/KristianScratch/logistic_growth/dev/Figures/Comparing_Models_PLOT.png)

![plot](/cloud/project/Figures/Comparing_Models_PLOT.png)

![plot](Figures/Comparing_Models_PLOT.png)
